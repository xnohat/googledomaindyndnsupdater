...
ConsoleWrite('Gooogle Domain DynDNS Updated at ' & _Now() & @CRLF & 'DEBUG: ' & $Response & @CRLF)
TraySetToolTip('Gooogle Domain DynDNS Updated at ' & _Now() & @CRLF & 'DEBUG: ' & $Response & @CRLF);
Sleep(30000);
WEnd
